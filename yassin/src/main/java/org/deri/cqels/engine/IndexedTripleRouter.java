...
public class IndexedTripleRouter extends OpRouterBase {
	...
	public void update(EnQuad enQuad) {		
		//Add to indexed buff
		System.out.println("received enQuad = "+enQuad.toString());
		System.out.println("["+dateFormat.format(new Date())+"] " + "Received triple");
		w.purge();
		buff.add(enQuad);
		...
		System.out.println("received = "+hMap.toString());
